...
const FRASES_POR_MOOD: Record<number, string[]> = {
  5: [
    'La alegría que sientes hoy es tuya, nació de todo lo que has construido 🌸',
    'Hay días que recuerdas para siempre. Que este sea uno de ellos ✨',
    'Cuando estás bien, el mundo a tu alrededor también lo nota 🌺',
    'Guarda este momento. Tu yo del futuro lo va a necesitar 💛',
    'Floreciste despacio y en silencio. Hoy se nota 🌿',
  ],
  4: [
    'Un día tranquilo también es un regalo. No todo tiene que brillar para valer 🍃',
    'Estás avanzando, aunque no lo sientas. Las raíces crecen antes que las flores 🌱',
    'La gratitud transforma lo ordinario en extraordinario 🌾',
    'Hoy no tienes que ser perfecta. Solo present 🕊️',
    'Lo que haces con calma, lo haces para siempre 🌙',
  ],
  3: [
    'Los días grises también forman parte del paisaje. Sin ellos no existiría el verde 🌫️',
    'La paz interior no depende de cómo te sientes, sino de cómo te tratas 🕊️',
    'Estar en equilibrio ya es un logro. No subestimes la calma 🌾',
    'No todos los días tienen que ser extraordinarios para que tu vida lo sea ✨',
    'Permítete ser humana. Eso también es fortaleza 🤍',
  ],
  2: [
    'Las emociones difíciles son mensajeras, no enemigas. Escúchalas con gentileza 🌧️',
    'Ser vulnerable no te hace débil, te hace honesta contigo misma 🫂',
    'Incluso en los días bajos, sigues siendo todo lo que has construido 🪺',
    'El dolor que sientes hoy está labrando la fortaleza de mañana 🌱',
    'Date permiso de no poder con todo. Tu nido te sostiene 🌙',
  ],
  1: [
    'Los días oscuros también pasan. Siempre pasan 🌧️',
    'No tienes que estar bien para merecer cuidado. Mereces cuidado exactamente como estás 🫶',
    'Respirar ya es suficiente hoy. Todo lo demás puede esperar 🤍',
    'Tu historia no termina aquí. Este capítulo también va a tener sentido 🪺',
    'Eres más fuerte de lo que crees, incluso cuando no te lo parece 🌱',
  ],
}

const FRASES_SUEÑO_MAL = [
  'El cansancio también merece compasión. Sé suave contigo hoy 🌙',
  'Tu cuerpo habló anoche. Escúchalo hoy con ternura 🤍',
  'Incluso cansada, sigues siendo capaz de cosas hermosas 🌿',
  'El descanso es sagrado. Date permiso de ir despacio hoy 🕊️',
  'No tienes que rendir al máximo cada día. Hoy simplemente estar ya es suficiente 🌧️',
]

const FRASES_SUEÑO_EXCELENTE = [
  'Dormiste bien y eso lo cambia todo. Tu cuerpo y tu mente están alineados 🌟',
  'El descanso es la base de todo lo que construyes. Hoy tienes los cimientos fuertes ✨',
  'Una noche de buen sueño es un acto de amor hacia ti misma 🌸',
  'Recargada y lista. Lo que hagas hoy va a tener tu mejor versión 💛',
  'El mundo se ve diferente cuando descansaste de verdad 🌤️',
]

const FRASES_GENERALES = [
  'Lo que eliges cultivar cada día define quién llegas a ser 🌱',
  'La vida que quieres está hecha de los días que decides construir 🪺',
  'No esperes el momento perfecto. Crea el momento con lo que tienes hoy ✨',
  'Tu constancia es silenciosa pero poderosa. Sigue 🌿',
  'Pequeños actos de cuidado, repetidos, se convierten en una vida hermosa 🌸',
  'Lo que haces con intención deja huella 🍃',
  'Eres el resultado de todo lo que has decidido sostener 💛',
  'Tu nido es el reflejo de lo que cuidas. Y lo cuidas bien 🪺',
  'Crecer no siempre se ve. Pero siempre se siente 🌾',
  'La mejor versión de ti no está lejos. Está en lo que haces hoy 🌙',
  'Confía en el proceso, incluso cuando no puedes ver el resultado 🕊️',
  'Mereces la misma dedicación que le das a todo lo demás 🤍',
]
